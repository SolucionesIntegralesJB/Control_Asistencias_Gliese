<?php
// --
class C_Igvbilling_Details extends Controller
{
  ...
  public function create_igvbilling()
  {
    ob_start();
    $this->functions->validate_session($this->segment->get('isActive'));
    ...
    if ($request === 'POST') {
      ...
      if (
        ...
        $obj = $this->load_model('Igvbilling_Details');
        $response = $obj->create_Igvbilling($billingData, $products);
