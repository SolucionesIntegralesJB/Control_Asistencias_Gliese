...
require __DIR__ . '/../../models/M_Igvbilling.php';

$id_igvbilling = isset($id_igvbilling) ? $id_igvbilling : null;

$client = new M_Igvbilling();
$rspta = $client->get_igvbilling_xml($id_igvbilling);
if ($rspta['status'] === 'OK' && !empty($rspta['result'])) {
    ...
    $rspta_detalle = $client->get_igvbilling_details_xml($id_igvbilling);
