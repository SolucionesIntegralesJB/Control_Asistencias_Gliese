...
<body>
    ...
    if (isset($proformaData) && $proformaData['status'] === 'OK' && !empty($proformaData['result'])) {
        ...
        $tipo_voucher = ($regc['id_voucher_type'] == '1') ? 'NOTA DE VENTA' : 'NOTA DE VENTA';
        ...
        $tiempo_entrega = $regc['time_delivery'] ?? '';
        $validez_oferta = $regc['validity'] ?? '';
    ...
    <div class="cliente">
        <table class="cuadro-cliente">
            ...
            <tr>
                <td style="width: 10%"><b>DNI/RUC</b></td>
        ...
        <table cellspacing="0" cellpadding="0" border="0.5" class="pagos">
            <tr>
                <td style="width:32.6%"><b>Fecha de Emisión</b><br>
                    <?php
                ...
                <td style="width:32.6%"><b>Moneda</b><br><?= $moneda; ?> </td>
                <td style="width:33.1%"><b>Asesor Comercial</b><br><?= $nombre_user ?></td>
        ...
        <table class="articulo" border="0.3" cellpadding="0" cellspacing="1" bordercolor="black" style="border-collapse:collapse;">
            ...
            ?>
                    <tr style="text-align:left">
                        ...
                        <td style="background-color: <?= $estilo; ?>; width:9.05%; padding-top: 5px; text-align: center;"><?= $regd['series']; ?></td>
    ...
    <div class="total" style="width: 85%; margin: 0 auto; font-family: Arial, sans-serif;">
        <table cellspacing="0" cellpadding="2" style="width: 100%; border-collapse: collapse; border: 0.5px solid black;">
            <tr style="background: #1D1B1B; color: white;">
                ...
                <td style="width: 20%; text-align: center; padding: 4px; border: 0.5px solid black; font-size: 10px; font-weight: bold;">IGV (<?= round($igv_asig / ($total_venta - $igv_asig) * 100, 2) ?>%)</td>
                <td style="width: 20%; text-align: center; padding: 4px; border: 0.5px solid black; font-size: 10px; font-weight: bold;">PRECIO TOTAL</td>
            </tr>
            <tr>
                <td style="text-align: right; padding: 4px; border: 0.5px solid black; font-size: 10px;">S/&nbsp;<?= number_format($total_venta - $igv_asig, 2, '.', ',') ?></td>
                <td style="text-align: right; padding: 4px; border: 0.5px solid black; font-size: 10px;">S/&nbsp;<?= number_format($igv_asig, 2, '.', ',') ?></td>
                <td style="text-align: right; padding: 4px; border: 0.5px solid black; font-size: 10px;">S/&nbsp;<?= number_format($importe, 2, '.', ',') ?></td>
            </tr>
        </table>
    </div>
                    ...
                    <td style="width: 100%;">
                        ...
                        <table style="width: 80%; border-collapse: collapse;">
                            <tr>
                                ...
                                <td style="width: 50%;">:WILDER FLORENTINO JULCA BRONCANO</td>
                            </tr>
                        </table>
                        <table style="width: 80%; border-collapse: collapse;">     
                            <tr>
                                <td style="width: 40%; font-weight: bold;">CUENTA SOLES BCP</td>
                                <td sytle="width: 40%; font-weight: bold">: 191-34789343-0-48</td>
                            </tr>
                        </table>
                    </td>
                </tr>
