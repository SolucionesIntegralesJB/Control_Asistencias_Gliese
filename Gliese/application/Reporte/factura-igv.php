...
<body>
  ...
  <div class="contenido">
    ...
    <table class="cuadro" border="0.3" cellpadding="0" cellspacing="1" bordercolor="black"
    ...
    <table class="articulo" border="0.3" cellpadding="0" cellspacing="1" bordercolor="black"
      style="border-collapse:collapse;">
      <?php
      ...
      <tr style="text-align:left">
        <td style="background-color: <?= $estilo; ?>; width:9.05%; padding-top: 5px; text-align: center;">
          <?= $regd['product_code']; ?></td>
        <td
          style="background-color: <?= $estilo; ?>; width:55%; height: 1.12px; padding-top: 5px; text-align: justify; padding: 5px">
          <?= $regd['product_description'] . " " . ($regd['series'] ?? ''); ?></td>
        <td style="background-color: <?= $estilo; ?>; width:10%; padding-top: 5px; text-align: center;">
          <?= $regd['quantity']; ?></td>
        <td style="background-color: <?= $estilo; ?>; width:13%; padding-top: 5px; text-align: right;">
          <?= number_format($precioV, 2, '.', ','); ?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td style="background-color: <?= $estilo; ?>; width:13%; padding-top: 5px; text-align: right;">
          <?= number_format($importe, 2, '.', ','); ?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
      </tr>
      <?php } ?>
      <br>
    </table>
  ...
  <div class="total">
    <table cellspacing="0" cellpadding="0" border="0.2">
      ...
      <tr style="width: 100%; text-align: center;">
        ...
        <td style="width:12%">S/ &nbsp;&nbsp;&nbsp;&nbsp; <?= number_format(($regd['discount'] ?? 0), 2, '.', ','); ?>
        </td>
        ...
        <tr class="cuadro-footer">
          <td style="width: 90%; padding-top: 5px">
            ...
            <b>
              <?php
                            ...
                            $formatter = new IntlDateFormatter('es_PE', IntlDateFormatter::LONG, IntlDateFormatter::NONE);
                            echo $formatter->format($date_inicio);
                            ?>
            </b><br>
          ...
          <td style=" width: 10%; text-align: center;">
            <?php
                        ...
                        $level = 'Q';
                        $framSize = 1;
                        $contenido = $rucE . '|' .  $voucher_type_code . '|' . $serie . '|' . $correlativo . '|' . $igv_asig . '|' . $total_venta . '|' . $fecha . '|' . $tipo_documento_cliente . '|' . $rucC . '|';
                        ob_start();
